                ...
                <div className="relative">
                    ...
                    <div className="space-y-12">
                        {experienceData.map((item, index) => (
                            <div key={item.id} className="relative flex flex-col md:flex-row gap-8 md:gap-24 pl-12 md:pl-0">
                                ...
                                <div className="absolute left-[30px] md:left-[250px] top-4 -translate-x-1/2 z-20">
                                    <svg width="24" height="24" viewBox="0 0 63 64" fill="none">
                                        <path d="M31.8294 63.9998C31.7677 46.3484 17.9887 32.0591 1.00012 32.0591C18.0266 32.0591 31.8294 17.7055 31.8294 -0.000183105C31.8908 17.6512 45.67 31.9405 62.6587 31.9405C45.6319 31.9405 31.8294 46.2941 31.8294 63.9998Z" fill={item.active ? "#C4EF17" : "#6B7FFF"} />
                                    </svg>
                                </div>
                                ...
                                <div className="flex-1">
                                    <motion.div
                                        ...
                                        className={`group p-8 md:p-10 rounded-[20px] bg-[#121211] border ${item.active ? 'border-[#C4EF17]/50' : 'border-white/5'} hover:border-[#C4EF17]/30 transition-all flex flex-col md:flex-row md:items-center justify-between gap-6`}
                                    >
                                        <div>
                                            <h3 className="text-[24px] md:text-[28px] font-bold text-white mb-2">{item.role}</h3>
                                            <p className="text-[#9FA0A6] text-lg max-w-xl">{item.description}</p>
                                        </div>
