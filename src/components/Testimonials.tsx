                    ...
                    {[
                        {
                            ...
                            text: "I am a UI/UX designer, and I’m very passionate and dedicated to my work. With 09 years experience as a professional."
                        },
                        {
                            name: "Jane Smith",
                        ...
                        <div key={index} className="p-10 rounded-[40px] bg-[#121211] border border-white/5 relative group hover:border-[#C4EF17]/30 transition-all">
